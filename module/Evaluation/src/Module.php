...
class Module implements ConfigProviderInterface
{
        ...
        return [
            'factories' => [
                ...
                Model\SurveyTableGateway::class => function ($container) {
                    ...
                    return new TableGateway('evaluation_answers', $dbAdapter, null, $resultSetPrototype);
                },
                Model\UserTableGateway::class => function ($container) {
                    $dbAdapter = $container->get(AdapterInterface::class);
                    $resultSetPrototype = new ResultSet();
                    $resultSetPrototype->setArrayObjectPrototype(new Model\User());
                    return new TableGateway('evaluation_users', $dbAdapter, null, $resultSetPrototype);
                },
            ],
        ];
    }
    ...
    public function getControllerConfig()
    {
        return [
            'factories' => [
                Controller\EvaluationController::class => function($container) {
