...
if(!empty($quest12)&&!empty($quest13)&&!empty($quest14)&&!empty($quest15)&&!empty($quest16)&&!empty($quest17)){
    ...
    $sql12="INSERT INTO PreTest(UserID,QuestionID,Answers) VALUES('$user','$qid12','$quest12')";
    $sql13="INSERT INTO PreTest(UserID,QuestionID,Answers) VALUES('$user','$qid13','$quest13')";
    $sql14="INSERT INTO PreTest(UserID,QuestionID,Answers) VALUES('$user','$qid14','$quest14')";
    $sql15="INSERT INTO PreTest(UserID,QuestionID,Answers) VALUES('$user','$qid15','$quest15')";
    $sql16="INSERT INTO PreTest(UserID,QuestionID,Answers) VALUES('$user','$qid16','$quest16')";
    $sql17="INSERT INTO PreTest(UserID,QuestionID,Answers) VALUES('$user','$qid17','$quest17')";
...
<html lang = "en">
	...
	<body>
		...
		<div class="surveyPage">
			...
			<form action="pre_page5.php" method="post">
