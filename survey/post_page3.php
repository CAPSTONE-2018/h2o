...
if(!empty($quest6)&&!empty($quest7)&&!empty($quest8)&&!empty($quest9)&&!empty($quest10)&&!empty($quest11)){
    ...
    $sql6="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid6','$quest6')";
    $sql7="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid7','$quest7')";
    $sql8="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid8','$quest8')";
    $sql9="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid9','$quest9')";
    $sql10="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid10','$quest10')";
    $sql11="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid11','$quest11')";
    ...
    header("location:post_page2.php");
...
<html lang = "en">
	...
	<body>
		...
		<div class="surveyPage">
			...
			<form action="post_page4.php" method="post">
