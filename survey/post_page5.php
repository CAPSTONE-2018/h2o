...
if(!empty($quest18)&&!empty($quest19)&&!empty($quest20)&&!empty($quest21)&&!empty($quest22)&&!empty($quest23)&&!empty($quest24)&&!empty($quest25)&&!empty($quest26)&&!empty($quest27)){
    ...
    $sql18="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid18','$quest18')";
    $sql19="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid19','$quest19')";
    $sql20="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid20','$quest20')";
    $sql21="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid21','$quest21')";
    $sql22="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid22','$quest22')";
    $sql23="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid23','$quest23')";
    $sql24="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid24','$quest24')";
    $sql25="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid25','$quest25')";
    $sql26="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid26','$quest26')";
    $sql27="INSERT INTO PostTest(UserID,QuestionID,Answers) VALUES('$user','$qid27','$quest27')";
    ...
    header("location:post_page4.php");
...
<html lang = "en">
	...
	<body>
		...
		<div class="surveyPage">
			...
			<form action="post_page6.php" method="post">
